...
class MixVisionTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
        ...
        self.patch_embed_side1 = OverlapPatchEmbed(img_size=img_size, patch_size=7, stride=4, in_chans=4,
                                                   embed_dim=embed_dims[0])
        self.guidance_embed = GuidanceEmbed(in_chans=4, embed_dim=embed_dims[1])
